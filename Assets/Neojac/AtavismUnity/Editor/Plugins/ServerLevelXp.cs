...
public class ServerLevelXp : AtavismDatabaseFunction
{
	...
	public Dictionary<int, LevelData> dataRegister;
	public LevelData editingDisplay;
	public LevelData originalDisplay;
	...
	public override void DrawEditor (Rect box, bool newItem)
	{
		...
		if (newItem) {
			ImagePack.DrawLabel (pos.x, pos.y, "Create a new Level Xp Requirement");		
			pos.y += ImagePack.fieldHeight;
		}
		
		editingDisplay.level = ImagePack.DrawField (pos, "Level:", editingDisplay.level);
		pos.y += ImagePack.fieldHeight;
		editingDisplay.xpRequired = ImagePack.DrawField (pos, "Xp Required:", editingDisplay.xpRequired);
